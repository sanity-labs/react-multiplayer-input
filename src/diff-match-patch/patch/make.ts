import {cleanupEfficiency, cleanupSemantic} from '../diff/cleanup'
import {type Diff, diff, DIFF_DELETE, DIFF_EQUAL, DIFF_INSERT} from '../diff/diff'
import {diffText1} from '../diff/diffText'
import {isLowSurrogate} from '../utils/surrogatePairs'
import {countUtf8Bytes} from '../utils/utf8Indices'
import {MAX_BITS} from './constants'
import {createPatchObject, type Patch} from './createPatchObject'
